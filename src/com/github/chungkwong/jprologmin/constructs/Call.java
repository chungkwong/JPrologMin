...
/**
 * Implementation of the control construct call/1
...
public class Call extends ControlConstruct{
	...
	public void firstexecute(Processor exec){
		...
		if(goal instanceof Variable){
			throw new com.github.chungkwong.jprologmin.InstantiationException((Variable)goal);
		}else if(!Helper.isCallable(goal)){
			throw new com.github.chungkwong.jprologmin.TypeException("callable",goal);
		}
